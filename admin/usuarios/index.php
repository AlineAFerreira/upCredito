        ...
        <div class="right_col" role="main">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div id="usuarios" class="dashboard_graph lista">

                        <div class="row x_title">
                            <div class="col-s-12">
                                <h3 class="title-cad">Usuários Cadastrados
                                    <a href="cadastro.php" class="btn btn-success btn-action">Novo Usuário</a>
                                </h3>
                            </div>                    
                        </div>                        
                        <div class="col-xs-12">
                            <div class="x_panel">
                                <div class="x_content">    
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <tr id="id_usuario_aqui" class="row-produto">
                                                ...
                                                <td>
                                                    <div class="box-action">
                                                        <a href="../usuarios/editar.php?id=1" title="Editar" class="btn-edit"><i class="fa fa-edit"></i></a>
