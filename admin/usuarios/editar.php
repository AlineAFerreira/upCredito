...
<body class="nav-md">
    <div class="container body">
      <div class="main_container">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div id="box-formProduto" class="">
                        ...
                        <div class="row x_title">
                            <div class="col-md-6">
                                <h3 class="title-cad">Edição de Usuário</h3>
                            </div>                    
                        </div>                        
                        <form class="" method="post" action="" id="form-usuario">
                            ...
                            <div class="x_panel" style="">
                                    ...
                                    <div class="x_content"> 
                                        ...
                                        <div class="form-group col-xs-12 col-sm-6 col-md-3">
                                            <button type="button" class="btn btn-info top_space20" data-toggle="modal" data-target="#usuarioModal">Resetar Senha</button>  
                                        </div>                                 
                                    </div>
                                </div>
                                ...
                                <div class="clearfix"></div>
                                <div class="col-xs-12 col-sm-6 alert alert-success reset top_space20">
        ...
        <!-- Modal -->
        <div class="modal fade modalAlert" id="usuarioModal" role="dialog">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-body">
                        <p class="text">Resetar senha do usuário?</p>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                        <button type="button" class="btn btn-danger" onclick="resetPassword()">Confirmar</a>
                    </div>
                </div>
            </div>
        </div>
