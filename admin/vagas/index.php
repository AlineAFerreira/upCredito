        ...
        <div class="right_col" role="main">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div id="vagas" class="dashboard_graph lista">

                        <div class="row x_title">
                            <div class="col-s-12">
                                <h3 class="title-cad">Vagas Cadastradas
                                    <a href="cadastro.php" class="btn btn-success btn-action">Nova Vaga</a>
                                </h3>
                            </div>                    
                        </div>                        
                        <div class="col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="box-action col-xs-12">    
                                                <a title="Excluir" class="btn-delete pointer" onclick="confirmModal(1, 1)">
                                                    <i class="fa fa-trash only"></i> <span>Excluir selecionados</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>                               
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <tr id="id_produto_aqui" class="row-produto">
                                                ...
                                                <td>Atuaar com Lorem ipsum dolor sit amet.</td>
                                                <td>R$ 1.200,00</td>
                                                <td>CLT (Efetivo)</td>
                                                <td>
                                                    <div class="box-action">
                                                        <a href="../vagas/editar.php?id=1" title="Editar" class="text-info btn-edit"><i class="fa fa-edit"></i></a>
