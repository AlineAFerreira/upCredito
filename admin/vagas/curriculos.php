                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div id="vagas" class="dashboard_graph lista">
                        ...
                        <div class="row x_title">
                            <div class="col-s-12">
                                <h3 class="title-cad">Currículos Recebidos
                                </h3>
                            </div>                    
                        </div>                        
                        <div class="col-xs-12">
                            <div class="x_panel">
                                <div class="x_content">  
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <tr id="id_curriculo" class="row-produto">
                                                <td><input type="checkbox"  name="table_records" class="flat"></td>
                                                <td>José</td>
                                                <td>(22)2525-2525</td>
                                                <td>jose@jose.com</td>
                                                <td>cscsc sdcsdcsc sdf</td>
                                                <td>
                                                    <div class="box-action">
                                                        <a href="../../assets/files/file.pdf" download="curriculum.pdf" title="Baixar Currículo" class="btn-download"><i class="fa fa-download "></i></a>
                                            ...
                                            <tr id="id_curriculo" class="row-produto">
                                                ...
                                                <td>jthhrttr rt rthh sdcsdcsc sdf</td>
                                                <td>
                                                    <div class="box-action">
                                                        <a href="../../assets/files/file.pdf" download="curriculum.pdf" title="Baixar Currículo" class="btn-download"><i class="fa fa-download "></i></a>
                                                        <a title="Excluir" class="btn-delete pointer" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i></a>
